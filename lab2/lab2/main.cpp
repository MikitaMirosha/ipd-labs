...
void getDevInfo(HANDLE diskHandle, STORAGE_PROPERTY_QUERY storageProtertyQuery) 
{
	...
	puts("_____________________________________");
	cout << "Producer: " << "Western Digital" << endl; 
	puts("_____________________________________");
...
void getMemoryInfo() 
{
	...
	cout << "Total space: " << totalDiskSpace.QuadPart * 1.0 / 1024 << " Gb" << endl;
	cout << "Free space: " << totalFreeSpace.QuadPart * 1.0 / 1024 << " Gb" << endl;
	cout << "Occupied space: " << (totalDiskSpace.QuadPart - totalFreeSpace.QuadPart) * 1.0 / 1024 << " Gb" << endl;
	puts("_____________________________________");
}
